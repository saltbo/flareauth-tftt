...
export const platformWebhookRoutes: ManagementRouteConfig[] = [
  ...
  },
  {
    ...
    summary: 'List trusted external issuers',
    response: listManagementTrustedIssuersResponseSchema,
  },
  {
    method: 'post',
    path: '/trusted-issuers',
    operationId: 'createTrustedIssuer',
    summary: 'Create trusted external issuer',
    request: { body: jsonBody(createManagementTrustedIssuerRequestSchema) },
    response: createManagementTrustedIssuerResponseSchema,
    status: 201,
  },
